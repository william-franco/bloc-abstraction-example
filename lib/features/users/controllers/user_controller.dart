import 'package:bloc_abstraction_example/common/controllers/state_controller.dart';
import 'package:bloc_abstraction_example/common/exception_handlings/exception_handling.dart';
  ...
  Future<void> getAllUsers() async {
    ...
    final users = switch (result) {
      ...
      Error(error: final error) =>
        UserErrorState(message: 'Something went wrong: $error'),
    };
    emitState(users);
    _debug();
  }
